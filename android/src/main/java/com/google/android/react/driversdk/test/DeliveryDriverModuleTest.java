...
public class DeliveryDriverModuleTest {
  @Mock Executor executor;

  @Mock DeliveryVehicle deliveryVehicle;

  ReactApplicationContext reactContext;
  DeliveryDriverModule ddm = null;
  ...
  @Test
  public void getName() {
    assertEquals("DeliveryDriverModule", ddm.getName());
  }

  @Test
  public void createDeliveryDriverInstance() {
    String providerId = "mobility-partner-access";
    String vehicleId = "vehicle_A003";

    try {
      ddm.createDeliveryDriverInstance(providerId, vehicleId, emptyPromise);
    } catch (Exception e) {
      fail(e.toString());
    }
  }
  ...
  public void setLocationTrackingEnabled() {
    try {
      ddm.setLocationTrackingEnabled(true, emptyPromise);
    } catch (Exception e) {
      fail(e.toString());
    }
  }
  ...
  public void setLocationReportingInterval() {
    try {
      ddm.setLocationReportingInterval(20, emptyPromise);
    } catch (Exception e) {
      fail(e.toString());
    }
  }
  ...
  public void clearInstance() {
    try {
      ddm.clearInstance(emptyPromise);
    } catch (Exception e) {
      fail(e.toString());
    }
  }
  ...
  @Test
  public void should_get_delivery_vehicle() {
    CompletableFuture<DeliveryVehicle> future = new CompletableFuture<>();
    executor = Executors.newSingleThreadExecutor();
    executor.execute(
        new Runnable() {
          @Override
          public void run() {
            future.complete(deliveryVehicle);
          }
        });
    try {
  ...
  public void getDeliveryVehicle() {
    try {
      ddm.getDeliveryVehicle(emptyPromise);
    } catch (Exception e) {
      fail(e.toString());
    }
  }
  ...
  public void setAbnormalTerminationReporting() {
    try {
      ddm.setAbnormalTerminationReporting(true);
    } catch (Exception e) {
      fail(e.toString());
    }
  }
