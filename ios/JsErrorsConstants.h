...
extern NSString* const kDriverApiNotInitializedErrorCode;
extern NSString* const kDriverApiNotInitializedErrorMessage;
extern NSString* const kDriverApiAlreadyExistsErrorCode;
